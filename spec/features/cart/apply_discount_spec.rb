...
RSpec.describe "adding an item to the cart" do
  before :each do
    @merchant = User.create(role:1, email: 'm5@gmail.com', active: true, name:"June's Produce", created_at: 10.days.ago, updated_at: 1.days.ago, city:"Denver", state:"CO", zip: 80209, address:"123 the road", password:"pw")
  ...
  context "a visitor or regular user can add items to the cart" do
    before :each do
      @user = User.create(role:0, email: 'r3@gmail.com', active: true, name:"Jud", created_at: 10.days.ago, updated_at: 1.days.ago, city:"Denver", state:"CO", zip: 80209, address:"123 hit the road", password:"pw")
    end
