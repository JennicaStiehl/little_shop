...
RSpec.describe 'merchant order show workflow' do
  describe 'as a merchant' do
    before :each do
      ...
      @item1 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant1, inventory: 2)
      @item2 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant2, inventory: 2)
      @item3 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant1, inventory: 2)
      @item4 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant1, inventory: 2)
    ...
    describe 'merchant fulfills items' do
      ...
      describe 'sets order as packaged if I am the last merchant to fulfill items' do
        before :each do
          ...
          @merchant_1 = create(:merchant)
          item_1 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant_1, inventory: 100)
          item_3 = create(:item, name: 'widget', slug: "widget-#{rand(10_000..99_999)}",  user: @merchant_1)
